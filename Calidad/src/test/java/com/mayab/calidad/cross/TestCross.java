...
public class TestCross {
	private static WebDriver driver;
	  ...
	  private static String URL = "https://Muganz11:4594cf41-49a6-4f6c-a8b6-aeda5633b8cc@ondemand.us-west-1.saucelabs.com:443/wd/hub";
	  ...
	  public static void setUp() throws Exception {
		...
		DesiredCapabilities caps = DesiredCapabilities.firefox();
		  ...
		  driver = new RemoteWebDriver(new java.net.URL(URL), caps);driver.get("https://mern-crud.herokuapp.com");
